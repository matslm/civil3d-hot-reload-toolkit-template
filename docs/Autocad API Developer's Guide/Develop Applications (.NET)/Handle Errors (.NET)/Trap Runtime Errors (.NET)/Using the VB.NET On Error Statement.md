---
title: "Using the VB.NET On Error Statements (.NET)"
source_url: "https://help.autodesk.com/cloudhelp/2026/ENU/OARX-DevGuide-Managed/files/GUID-6E5D85C0-5F00-40A7-920A-2CD4D77DF8AA.htm"
hierarchy: ["ObjectARX and Managed .NET", "ObjectARX: Managed .NET Developer's Guide", "Develop Applications (.NET)", "Handle Errors (.NET)", "Trap Runtime Errors (.NET)", "Using the VB.NET On Error Statements (.NET)"]
---

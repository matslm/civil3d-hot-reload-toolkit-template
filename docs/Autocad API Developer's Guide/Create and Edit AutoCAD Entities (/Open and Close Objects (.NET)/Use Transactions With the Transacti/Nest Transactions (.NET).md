---
title: "Nest Transactions (.NET)"
source_url: "https://help.autodesk.com/cloudhelp/2026/ENU/OARX-DevGuide-Managed/files/GUID-8D8B9EE8-9D85-4C29-93A0-0BDC90F66EA7.htm"
hierarchy: ["ObjectARX and Managed .NET", "ObjectARX: Managed .NET Developer's Guide", "Create and Edit AutoCAD Entities (.NET)", "Open and Close Objects (.NET)", "Use Transactions With the Transaction Manager (.NET)", "Nest Transactions (.NET)"]
---
...
![](../images/GUID-ECA5C137-B00E-4686-8086-86EB4DC55F6E.png)

## Use nested transactions to create and modify objects

The following example demonstrates using three transactions to create a
`Circle` and
`Line` object, and then change their colors. The color of the circle is changed in the second and third transaction, but since the third transaction is aborted only the changes made in the first and second transactions are saved to the database. Additionally, the number of active transactions is printed in the Command Line window as they are created and closed.

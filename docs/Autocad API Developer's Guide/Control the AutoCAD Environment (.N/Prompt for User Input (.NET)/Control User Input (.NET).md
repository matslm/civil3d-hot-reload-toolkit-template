---
title: "Control User Input (.NET)"
source_url: "https://help.autodesk.com/cloudhelp/2026/ENU/OARX-DevGuide-Managed/files/GUID-3D998905-0C24-4FF9-A9C7-7F361A591B80.htm"
hierarchy: ["ObjectARX and Managed .NET", "ObjectARX: Managed .NET Developer's Guide", "Control the AutoCAD Environment (.NET)", "Prompt for User Input (.NET)", "Control User Input (.NET)"]
---
...
`GetPoint` method to have the user specify a point or respond with a keyword. This is how commands like LINE, CIRCLE, and PLINE work.

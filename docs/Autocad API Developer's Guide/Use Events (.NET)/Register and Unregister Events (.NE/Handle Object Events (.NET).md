---
title: "Handle Object Events (.NET)"
source_url: "https://help.autodesk.com/cloudhelp/2026/ENU/OARX-DevGuide-Managed/files/GUID-E30279D1-E4B5-48A4-A3D8-9CEC83BD0967.htm"
hierarchy: ["ObjectARX and Managed .NET", "ObjectARX: Managed .NET Developer's Guide", "Use Events (.NET)", "Register and Unregister Events (.NET)", "Handle Object Events (.NET)"]
---
...
You define an object level event by registering an event handler with the event of a database object. Database level object events are defined by registering an event handler with one of the events of an open
`Database` object.
